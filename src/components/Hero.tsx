    ...
    <section id="hero" className="relative min-h-screen flex flex-col items-center justify-center text-center px-4 overflow-hidden">
      ...
      >
        ...
        <h1 className="text-5xl md:text-7xl font-bold tracking-tight pb-6 bg-gradient-to-b from-white to-slate-400 bg-clip-text text-transparent">
          Diseño experiencias <br /> digitales de alto impacto.
        </h1>
        <p className="text-lg text-slate-400 mb-10 max-w-2xl mx-auto leading-relaxed">
          Más de 3 años construyendo soluciones escalables con arquitecturas limpias y una obsesión por el detalle visual. Especialista en React, Next.js y Aplicaciones Móviles.
        </p>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          >
            Experiencia Laboral <ChevronRight size={18} className="group-hover:translate-x-1 transition-transform" />
          </motion.a>
        </div>
      </motion.div>
    </section>
